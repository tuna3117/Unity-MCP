...
namespace Project.Basket
{
    ...
    public static class HoopColumnBuilder
    {
        ...
        public static Result Build(Transform parent, HoopLayout layout, BasketSettings s, int layerHoop, int layerSlab)
        {
            ...
            Wall(root.transform, "WallLeft", new Vector3(-layout.WallX - 0.1f, midY, zMid), new Vector3(0.2f, height, depth), s.WallMaterial, wallVisual, true, layerHoop);
            Wall(root.transform, "WallRight", new Vector3(layout.WallX + 0.1f, midY, zMid), new Vector3(0.2f, height, depth), s.WallMaterial, wallVisual, true, layerHoop);
            ...
            Wall(root.transform, "Facade", new Vector3(0f, (backTop + backBottom) * 0.5f, -s.SlabHalfDepth - 0.1f),
                new Vector3(layout.WallX * 2f + 0.4f, backTop - backBottom, 0.2f), s.WallMaterial, wallVisual, true, layerHoop);
